...
def statement_list():
    if parser.current_token == 10: # ID
        ...
        statement_prime()
        statement_list()
    elif parser.current_token == 21: # {
        parser.match(21)
        declarations.local_declarations()
        statement_list()
        parser.match(22)
        statement_list()
    elif parser.current_token == 32: # if
        parser.match(32)
        parser.match(17)
        ...
        statement_list()
    elif parser.current_token == 36: # while
        parser.match(36)
        parser.match(17)
        expressions.expression()
        parser.match(18)
        statement()
        statement_list()
    elif parser.current_token ==  34: # return
        parser.match(34)
        return_stmt_prime()
        statement_list()
    elif parser.current_token == 37: # input
        parser.match(37)
        parser.match(10)
        var_prime()
        parser.match(12)
        statement_list()
    elif parser.current_token == 38: # output
        parser.match(38)
        expressions.expression()
        parser.match(12)
        statement_list()
